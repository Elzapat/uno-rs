/* The code in this file was entierely copy pasted from
 * https://github.com/naia-lib/naia/tree/main/demos/demo_utils/demo_world */
use std::collections::HashMap;
use std::marker::PhantomData;

use naia_shared::{
    BigMap, BigMapKey, ComponentUpdate, NetEntityHandleConverter, ProtocolInserter, Protocolize,
    ReplicaDynMutWrapper, ReplicaDynRefWrapper, ReplicaMutTrait, ReplicaMutWrapper,
    ReplicaRefTrait, ReplicaRefWrapper, Replicate, ReplicateSafe, WorldMutType, WorldRefType,
};
